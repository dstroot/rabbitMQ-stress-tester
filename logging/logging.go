...
// LogThreshold Level returns the current global log threshold.
func LogThreshold() Level {
	return logThreshold
}

// StdoutThreshold Level returns the current global output threshold.
...
// SetLogFile Conveniently Sets the Log Handle to a io.writer created for the file behind the given filepath
...
// UseTempLogFile Conveniently Creates a temporary file and sets the Log Handle to a io.writer created for it
...
// DiscardLogging Disables logging for the entire JWW system
func DiscardLogging() {
